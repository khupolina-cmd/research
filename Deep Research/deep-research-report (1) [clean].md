...
- **Поисковая архитектура**
 ...
 - Инструменты: web search; scholarly indexes; saved searches; reference tracking. PRISMA и Cochrane прямо требуют прозрачного описания поиска, документации процессов отбора и работы с grey literature/reference lists.
...
- **Оценка качества, bias и conflicts**
 ...
 - Инструменты: risk-of-bias frameworks; confidence rubrics. Cochrane использует RoB 2 и смежные инструменты для оценки риска систематической ошибки, а GRADE — для оценки уверенности в совокупном корпусе доказательств.
...
- **Модель синтеза**
 ...
 - Инструменты: matrix views; graph maps; dashboards; report templates. Evidence gap maps выделяются как отдельный систематический продукт для обзора корпуса и фиксации лакун.
...
Эта ветка — не каталог софта, а карта ролей в системе: discovery, collection, organization, screening, extraction, verification, synthesis, refresh. На практике сильный стек обычно комбинирует библиографическую инфраструктуру, AI-assisted retrieval, review software, data-cleaning слой и архивирование источников.
...
- **Школьная и академическая поисковая инфраструктура**
 ...
 - Инструменты: Zotero для коллекций/тегов/аннотаций; OpenAlex API; Crossref REST API; Semantic Scholar API; arXiv API.
...
- **Reference management**
 ...
 - Инструменты: Zotero; citation styles; shared libraries.
...
- **AI research assistants**
 ...
 - Инструменты: Elicit; Scite; Consensus; NotebookLM. Elicit позиционируется как инструмент для поиска, суммаризации и extraction по 125M+ papers; Scite — как слой Smart Citations; Consensus — как academic search engine с cited syntheses; NotebookLM — как source-grounded notebook с inline citations.
...
- **Citation mapping и literature discovery**
 ...
 - Инструменты: Connected Papers; Litmaps; ResearchRabbit; Citation Gecko.
...
- **Review management platforms**
 ...
 - Инструменты: Covidence; Rayyan; EPPI-Reviewer; CADIMA.
...
- **Capture, clipping, archiving**
 ...
 - Инструменты: Wayback Machine; Save Page Now; local PDF/archive folders.
...
- **Data cleaning и normalization**
 ...
 - Инструменты: OpenRefine; spreadsheets; database constraints.
...
- **Saved searches и alert architecture**
 ...
 - Инструменты: Google Alerts; PubMed My NCBI saved searches; platform-native alerts.
...
- **Feed-based monitoring**
 ...
 - Инструменты: Feedly и Feedly AI. Feedly позиционируется как слой для отслеживания тем и трендов, а Feedly AI — как набор моделей для research/intelligence и noise reduction.
...
- **Page-change detection**
 ...
 - Инструменты: Visualping; Distill.
...
- **API harvesting**
 ...
 - Инструменты: OpenAlex API; Crossref REST/Event Data; Semantic Scholar API; arXiv API/OAI-PMH; openFDA.
...
- **Orchestration и scheduling**
 ...
 - Инструменты: GitHub Actions schedule; Apache Airflow; Dagster; dbt как transformation layer. GitHub Actions поддерживает scheduled workflows по cron; Airflow — author/schedule/monitor workflows; Dagster — orchestration с lineage и observability.
...
- **Normalization, dedupe и entity resolution**
 ...
 - Инструменты: OpenRefine; custom rules; ID registries.
...
- **Платные news и media-intelligence базы**
 ...
 - Инструменты: Dow Jones Factiva; LexisNexis Nexis/Nexis+ AI. Factiva и Nexis дают платный доступ к глобальным архивам news/data с исследовательскими функциями.
...
- **Private market и company intelligence**
 ...
 - Инструменты: Crunchbase; PitchBook.
...
- **Digital market intelligence**
 ...
 - Инструменты: Similarweb; Sensor Tower. Similarweb и Sensor Tower прямо позиционируют свои продукты как intelligence/estimation platforms, а не first-party truth, поэтому их лучше трактовать как directional evidence.
...
- **Commercial market research**
 ...
 - Инструменты: Euromonitor International; Statista-like secondary datasets.
...
- **Court, legal и regulatory records**
 ...
 - Инструменты: EDGAR и U.S. Securities and Exchange Commission filings; PACER; agency portals. EDGAR дает free access к filings, PACER — к федеральным court records.
...
- **Patents, clinical и regulated-domain registries**
 ...
 - Инструменты: USPTO Patent Public Search; Google Patents; ClinicalTrials.gov; EU Clinical Trials; openFDA.
...
- **Government records by request**
 ...
 - Инструменты: FOIA.gov и agency-specific request systems. FOIA прямо рекомендует сначала проверить, не опубликованы ли данные уже публично, и указывает, что агентства не обязаны «проводить исследование» вместо заявителя.
...
- **Expert networks и первичные интервью**
 ...
 - Инструменты: GLG; AlphaSights; Guidepoint; Tegus/AlphaSense expert products. Эти платформы позиционируют себя как access layer к subject-matter experts и expert calls, а не как final truth layer.
...
- **Lateral reading**
 ...
 - Инструменты: search; fact-check tools; archive search. SIFT/lateral reading используется как практическая модель быстрой проверки цифровых источников.
...
- **Версионирование, corrections и retractions**
 ...
 - Инструменты: Crossmark; Retraction Watch Database; publisher update policies. Crossmark показывает current status записи, а Retraction Watch ведет регулярно обновляемую базу retractions.
...
- **Media verification**
 ...
 - Инструменты: TinEye; Google Fact Check Tools; C2PA / Content Credentials / Verify. TinEye предназначен для reverse image search, Fact Check Tools — для поиска уже проверенных claims/images, C2PA — для provenance metadata.
...
- **AI output verification**
 ...
 - Инструменты: grounded notebooks; evidence tables; link checking. NIST прямо рекомендует риск-ориентированное управление GenAI с учетом специфических рисков генеративных систем.
...
- **Confidence scoring и uncertainty communication**
 ...
 - Инструменты: GRADE-like scales; evidence gap maps.
